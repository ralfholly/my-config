...
export GREP_COLORS="mt=1;44;33"
export ACK_COLOR_MATCH="bold yellow on_blue"
...
LOCAL_PIP_BIN_PATH=~/.local/bin
export PATH=$PATH:$LOCAL_PIP_BIN_PATH
# Get rid of annoying Wine 'fixme' messages.
